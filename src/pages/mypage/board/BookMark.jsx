...
const maxBoardLength = 6; // 한 번에 보여 줄 게시글 개수
...
const BookMark = () => {
  ...
  const [myArticle, setMyArticle] = useState(initialBoard); // 북마크 게시글
    ...
    for (let i = startPage; i <= lastPage; i++) {
      page.push(
        <Link
          ...
          to={`/mypage?page=${i}`}
          onClick={() => {
            sessionStorage.setItem('bookMark', i);
          }}
